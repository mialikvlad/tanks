...
import static com.company.game.Player.SPRITE_SCALE;
...
public abstract class Entity {
    ...
    protected boolean isImpassableTile(Integer... tileNum) {
        for (int i = 0; i < tileNum.length; i++)
            if (tileNum[i] == TileType.BRICK.numeric() || tileNum[i] == TileType.METAL.numeric() || tileNum[i] == TileType.WATER.numeric()) {
                return true;
            }
        return false;
    }
